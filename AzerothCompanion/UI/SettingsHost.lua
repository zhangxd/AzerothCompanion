...
local ENCOUNTER_JOURNAL_PAGE_RESET_REFS = { -- 冒险手册页专属设置引用
  { id = SettingId.ENCOUNTER_JOURNAL_MOUNT_FILTER_ENABLED, scope = ACCOUNT_SCOPE },
  { id = SettingId.ENCOUNTER_JOURNAL_DROP_FILTER_TYPE, scope = ACCOUNT_SCOPE },
  { id = SettingId.ENCOUNTER_JOURNAL_DROP_FILTER_OWNERSHIP, scope = ACCOUNT_SCOPE },
  { id = SettingId.ENCOUNTER_JOURNAL_LIST_PIN_ALWAYS_VISIBLE, scope = ACCOUNT_SCOPE },
}
